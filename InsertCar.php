...
if (isset($_POST['send']))
{
	...
	if (isset($_POST['title']) && empty ($_POST['title']))
	{
		...
		$errors['titleerror']="You should entire name";
	}
}else{
...
if (count($errors)<=0)
{
	...
	values('$title','$conent','$price','$model','$type','$pro','$image')");
}
		...
		<div class="container">
			<form method="POST" action="<?php echo $_SERVER['PHP_SELF']; ?>" class="m-auto" style="max-width:600px" enctype="multipart/form-data">
				...
				<div class="form-group mb-3 row"><label for="insert10" class="col-md-5 col-form-label"></label>
					<div class="col-md-7"><button class="btn btn-primary btn-lg" type="submit" name="send">Insert</button></div>
				</div>
			</form>
		</div>
	</body>
